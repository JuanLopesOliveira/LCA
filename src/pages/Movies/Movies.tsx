...
export default function Movies() {
    ...
    useEffect(() => {
        ...
        const movieURL = `${movieBaseURL}${selectedCategory}?${apiKey}&language=${navigatorLanguage}&region=br&page=${page}`;
    ...
    return (
        <div className={styles.MoviesRoot}>
            ...
            <div className={styles.ListMovies}>
                {
                    movies.map(movie => {
                        return <MediaCard movie={movie} key={movie.id} showLink={true} />
                    })
                }
            </div>
